				...
				<ul class="unstyled-list">
					<li class="step current">
						...
						<select name="source" class="source">
							<option value="">- -</option>
							<option value="csv_upload"><?php _e('CSV file from my computer', 'vg_sheet_editor' ); ?></option>
							<option value="csv_url"><?php _e('CSV file from url', 'vg_sheet_editor' ); ?></option>
							<option value="paste"><?php _e('Copy & paste from another spreadsheet or table', 'vg_sheet_editor' ); ?></option>
							<option value="server_file"><?php _e('CSV file in the server', 'vg_sheet_editor' ); ?></option>
						</select>
