...
jQuery(document).ready(function(){if("undefined"==typeof hot)return!0;hot.updateSettings({cells:function(e,t,s){var o=this.instance.toVisualRow(e),n={};"object"==typeof vgse_editor_settings.columnsBackgroundColors&&vgse_editor_settings.columnsBackgroundColors[s]?n.className="bg-"+vgse_editor_settings.columnsBackgroundColors[s].replace("#",""):n.className&&-1<n.className.indexOf("bg-")&&delete n.className;var l=vgse_editor_settings.final_spreadsheet_columns_settings[s];if(l){if(!l.is_locked&&(vgse_editor_settings.watch_cells_to_lock||"post_status"===s))if((r=hot.getDataAtCell(o,t))&&"string"==typeof r&&-1<r.indexOf("vg-cell-blocked"))if(n.renderer="wp_locked",n.readOnly=!0,n.editor=!1,n.fillHandle=!1,vgse_editor_settings.allow_cell_comments)"product_variation"===(i=hot.getDataAtRowProp(o,"post_type"))&&vgse_editor_settings.texts.column_for_parent_products_only?n.comment={value:vgse_editor_settings.texts.column_for_parent_products_only}:"product"===i&&vgse_editor_settings.texts.column_for_variations_only&&(n.comment={value:vgse_editor_settings.texts.column_for_variations_only});if(l.is_locked&&l.allow_to_save&&-1<vgse_editor_settings.lockedColumnsManuallyEnabled.indexOf(s)&&((n=l.formatted).readOnly=!1,n.fillHandle=!0,n.renderer=l.formatted.renderer||"text"),vgse_editor_settings.post_type===vgse_editor_settings.woocommerce_product_post_type_key&&"post_status"===s){n.selectOptions=l.formatted.selectOptions;var i,r=hot.getDataAtCell(o,t);"product_variation"===(i=hot.getDataAtRowProp(o,"post_type"))&&(n.selectOptions={publish:n.selectOptions.publish,delete:n.selectOptions.delete})}}return n}})});
