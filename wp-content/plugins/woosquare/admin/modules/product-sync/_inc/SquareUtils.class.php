...
class WooSquare_Utils {
	 ...
	 * See: https://docs.connect.squareup".get_transient('is_sandbox').".com/api/connect/v1/#datatype-itemvariation
	 *
	 ...
	 * See: https://docs.connect.squareup".get_transient('is_sandbox').".com/api/connect/v1/index.html#put-itemid
	 *
	 ...
	 * See: https://docs.connect.squareup".get_transient('is_sandbox').".com/api/connect/v1/index.html#post-items
	 *
	 * @param WC_Product $wc_product
	 * @param bool       $include_category
	 * @param bool       $include_inventory
	 ...
	 *
	 * See: https://docs.connect.squareup".get_transient('is_sandbox').".com/api/connect/v1/#datatype-item
	 ...
	 *
	 * See: https://docs.connect.squareup".get_transient('is_sandbox').".com/api/connect/v1/#workingwithmonetaryamounts
	 *
	 * @param int $price
	 * @return int
	 */
