...
var external_wp_hooks_ = __webpack_require__(12);
...
var external_wc_wcSettings_ = __webpack_require__(9);
...
const getLocationOptions = () => {
  ...
  const prlLocationOptions = (adminSettings === null || adminSettings === void 0 ? void 0 : adminSettings.prlLocationOptions) || [];
...
var external_wp_date_ = __webpack_require__(13);

// EXTERNAL MODULE: external ["wc","number"]
var external_wc_number_ = __webpack_require__(8);

// EXTERNAL MODULE: external ["wc","date"]
var external_wc_date_ = __webpack_require__(7);
...
var external_wp_dom_ = __webpack_require__(20);
...
class table_RevenueReportTable extends external_wp_element_["Component"] {
  ...
  getRowsContent() {
    ...
    const admin = Object(external_wc_wcSettings_["getSetting"])('admin', {});
    const dateFormat = admin.dateFormat ? admin.dateFormat : external_wc_date_["defaultTableDateFormat"];
    const {
...
class revenue_RevenueReport extends external_wp_element_["Component"] {
  getChartMeta() {
    ...
    const label = Object(external_wp_i18n_["__"])('%d conversions', 'woocommerce-product-recommendations');
...
/* harmony default export */ var analytics_report = (Report);
...
Object(external_wp_hooks_["addFilter"])('woocommerce_admin_reports_list', 'woocommerce-product-recommendations', reports => {
  return [...reports, {
