...
class WC_PRL_Condition_Cart_Product extends WC_PRL_Condition {
	...
	public function get_admin_fields_html( $post_name, $condition_index, $condition_data ) {
		...
		<div class="os_row_inner">
			...
			<div class="os_value">
				<select class="sw-select2-search--products" name="<?php echo $post_name; ?>[conditions][<?php echo $condition_index; ?>][value][]" data-placeholder="<?php _e( 'Search for a product&hellip;', 'woocommerce-product-recommendations' ); ?>" data-action="woocommerce_json_search_products_and_variations" multiple="multiple" data-limit="100" data-sortable="true">
					<?php
